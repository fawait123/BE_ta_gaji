...
class TunjanganController extends Controller
{
    ...
    {
        try{
            $storeData = Tunjangan::create($request->all());
            $data = [
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(TunjanganRequest $request)
    {
        try{
            $check = Tunjangan::where('id',$request->id)->first();
            if($check){
                $updateData = Tunjangan::where('id',$request->id)->update($request->all());
                $data = [
    ...
    {
        try{
            $check = Tunjangan::find($request->id);
            if($check){
               $check->delete();
               $data = [
